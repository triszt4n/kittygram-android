...
import hu.triszt4n.kittygram.databinding.ListRowKittyBinding
...
class WebKittyListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = WebKittyViewHolder(
            ListRowKittyBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
    ...
    inner class WebKittyViewHolder(val binding: ListRowKittyBinding) : RecyclerView.ViewHolder(binding.root)
}
